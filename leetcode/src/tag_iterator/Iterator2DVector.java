...
public class Iterator2DVector {
	...
	public static void main(String[] args) {
		...
		vec2d.add(line1);
		vec2d.add(line2);
		Iterator2DVector vct = new Iterator2DVector(vec2d);
...
//		}
	...
	public Iterator2DVector(List<List<Integer>> vec2d) {
		this.list = vec2d;
		rowIndex = 0;
		colIndex = 0;
	}
	...
	public void remove() {
		...
		// the colIdx == 0 now current colIndex points to the beginning
		// the previous element is in last row. we will remove the last row.
		// this won't change the row index and the column index
		if (colIndex == 0) {
