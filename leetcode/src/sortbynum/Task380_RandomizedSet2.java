 ...
 *
 */
public class Task380_RandomizedSet2 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Task380_RandomizedSet2 sln = new Task380_RandomizedSet2();
		try {
			int rand0 = sln.getRandom();
		} catch (Exception e) {
    ...
    public int getRandom() throws Exception{
    	if (list == null || list.isEmpty()) {
			throw new Exception("input can not be zero");
		}
