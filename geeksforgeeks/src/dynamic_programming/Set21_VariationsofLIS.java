...
public class Set21_VariationsofLIS {
	 ...
	 * sets (a, b) and (c, d), the second set can follow the first set if b < c.
	 * So you can form a long chain in the similar fashion. Find the longest
	 * chain which can be formed. The solution to this problem has been
	 * published here.
	 * 
	 * 
	 * 
	 * 4. Box Stacking You are given a set of n types of rectangular 3-D boxes,
	 * where the i^th box has height h(i), width w(i) and depth d(i) (all real
	 ...
	 * dimensions of the 2-D base of the lower box are each strictly larger than
	 * those of the 2-D base of the higher box. Of course, you can rotate a box
	 * so that any side functions as its base. It is also allowable to use
	 * multiple instances of the same type of box. Source: Dynamic Programming
	 * Practice Problems. The link also has well explained solution for the
	 * problem.
	 */
	
	/*
	 * Coding the build bridge
	 */
}
