...
//		 test1_2();
	...
	public static void test1_2() {
		int[] array = { -1, -3, 4, -2, 5 };
		int[] res2 = task1_2_largestSumArray_print(array);
		System.out.println(Arrays.toString(res2));
	}
	
	public static int[] task1_2_largestSumArray_print(int[] array) {
		int curSum = 0;
		int maxSum = Integer.MIN_VALUE;
		int endIdx = -1;
		for(int i = 0; i < array.length; i++) {
		...
		// get the startIdx.   [startIdx, endIdx] is the subarray with max sum
		int maxSumCpy = maxSum;
		int startIdx = endIdx;
		while(maxSumCpy != 0 && startIdx >= 0) { // make sure startIdx >= 0, otherwise, will be out of bounds
	...
	public static void test1_3() {
		...
		int maxSum = task1_3_sub_matrix_largest_sum(matrix);
		int maxSum2 = task1_3_sub_matrix_largest_sum_2(matrix);
	}

	public static int task1_3_sub_matrix_largest_sum(int[][] matrix) {
		// write your solution here
	...
	public static Wrapper task1_3_largestSumSubArray(int[] array) {
		...
		int maxSumCpy = maxSum;
		int startIdx = endIdx;
		while (maxSumCpy != 0 && startIdx >= 0) { // make sure startIdx >= 0,
													// otherwise, will be out of
													// bounds
			maxSumCpy -= array[startIdx];
			startIdx--;
		}
		startIdx++;
		return new Wrapper(startIdx, endIdx, maxSum);
	}
	...
	public static int task1_3_sub_matrix_largest_sum_2(int[][] matrix) {
		int rLen = matrix.length;
		int cLen = matrix[0].length;
	...
	public static void t2_1_3_maxProduct_print(int[] array) {
		if (array == null || array.length == 0) {
			return;
		}
		int prev_max = 1;
	 ...
	 * task3.1
	 * 
	 * Longest 1s Given an array containing only 0s and 1s, 
	 * find the length of the longest subarray of consecutive 1s. Assumptions The given array is
